...
import com.lumatik.course.CourseRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        users.save(students);
        users.save(new User("mikejgulley", "Mike", "Gulley", "12345", new String[] {"ROLE_USER", "ROLE_ADMIN"}));
        ...
        IntStream.range(0, 100)
                .forEach(i -> {
                    ...
                    Review review = new Review((i % 5) + 1, String.format("Moar %s please!!!", buzzword)); // + 1 b/c could return 0 otherwise
